    ...
    >
      ...
      {!hasVideo && src && (
        ...
        >
          <Image
            src={src}
            alt="Liquid Glass Phone"
            width={PHONE_WIDTH}
            height={PHONE_HEIGHT}
            className="block size-full object-cover border object-top"
          />
        </div>
      )}
      ...
      >
        <div className="w-full h-full mt-12  overflow-auto [mask-composite:intersect] [mask-image:linear-gradient(to_top,transparent,black_6rem)]">
          {children}
        </div>
      </div>
    </div>
