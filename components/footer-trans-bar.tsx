...
export default function FooterTransBar() {
    return (
        <div className="w-full bg-transparent space-y-[2px]">
            {/*  White to Black Gradient Lines */}
            ...
            <div className="w-full h-[6px] bg-gray-100"></div>
            ...
            <div className="w-full h-[6px] bg-gray-500"></div>
        </div>
    )
}