        ...
        <section
            ...
            <div className="text-start w-full max-w-5xl flex flex-row space-x-8">
                <div className="flex flex-col space-y-8">
                    <p className=" text-white text-3xl font-[--font-lora] leading-tight tracking-tight">Otopair reads your request, finds the right shop,<br />syncs calendars, and confirms payment in one flow.</p>
            ...
            <Marquee className="w-[25%] backdrop-blur-xl rounded-lg py-3 [mask-composite:intersect] [mask-image:linear-gradient(to_right,transparent,white_6rem),linear-gradient(to_left,transparent,black_6rem)] space-x-4 flex flex-row items-center">
                {
                    IconsArray.map((item) => (
